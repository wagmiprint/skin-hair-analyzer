            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center lg:items-start gap-4">
              ...
              <Dialog>
                <DialogTrigger asChild>
                  <Button variant="outline" size="lg" className="gap-2 h-14 px-8 text-base border text-foreground hover:bg-muted">
                ...
                <DialogContent className="max-w-md w-[95vw] p-0 overflow-hidden gap-0">
                  <DialogHeader className="sr-only">
                    <DialogTitle>Free AI Assessment</DialogTitle>
                  </DialogHeader>
                  <iframe
                    src="https://scan.eradna.com/"
                    title="Era Free AI Assessment"
                    className="w-full h-[620px] max-h-[85vh] border-0"
                  />
                </DialogContent>
              </Dialog>
            </div>
